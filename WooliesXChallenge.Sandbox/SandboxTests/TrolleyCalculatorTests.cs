...
using Xunit;
using TrolleyCalculator = WooliesXChallenge.Sandbox.Service.TrolleyCalculator;

namespace WooliesXChallenge.Sandbox.SandboxTests
{
    public class TrolleyCalculatorTests
    {
        ...
        //[Fact]
        public void CalculateCheapestTrolley_Test_2()
        {
            var trolley = new Trolley
            {
                Products = new List<Product>
